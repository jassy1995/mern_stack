            ...
            <Card.Body>
              ...
              <ListGroup variant="flush">
                <ListGroup.Item>
                  <Row>
                    <Col>Items</Col>
                    <Col>{formatter(cart.itemsPrice.toFixed(2))}</Col>
                  </Row>
                </ListGroup.Item>
                <ListGroup.Item>
                  <Row>
                    <Col>Shipping</Col>
                    <Col>{formatter(cart.shippingPrice.toFixed(2))}</Col>
                  </Row>
                </ListGroup.Item>
                <ListGroup.Item>
                  <Row>
                    <Col>Tax</Col>
                    <Col>{formatter(cart.taxPrice.toFixed(2))}</Col>
                  </Row>
                </ListGroup.Item>
                <ListGroup.Item>
                  <Row>
                    ...
                    <Col>
                      <strong>{formatter(cart.totalPrice.toFixed(2))}</strong>
                    </Col>
                  </Row>
                </ListGroup.Item>
                <ListGroup.Item>
                  ...
                  {loading && <FetchingSpinner></FetchingSpinner>}
                </ListGroup.Item>
              </ListGroup>
            </Card.Body>
          </Card>
